...
// PROTECTED REGION END
  ...
  protected function getAttributeDescriptions() {
    return [
      ...
      *
      */
      'id' => new RDBAttributeDescription('id', '', ['DATATYPE_IGNORE'], null, '', '', false, 'text', 'text', 'Image', 'id'),
     /**
      *
      */
      'fk_location_id' => new RDBAttributeDescription('fk_location_id', '', ['DATATYPE_IGNORE'], null, '', '', false, 'text', 'text', 'Image', 'fk_location_id'),
     /**
      *
      */
