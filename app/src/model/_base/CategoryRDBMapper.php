...
// PROTECTED REGION END
  ...
  protected function getRelationDescriptions() {
    return [
      'marker' => new RDBOneToManyRelationDescription(
        'app.src.model.Category', 'category', 'app.src.model.Marker', 'marker',
        '1', '1', '0', 'unbounded', 'none', 'composite', 'true', 'true', 'child', 'id', 'fk_category_id'
      ),
 ...
 * - $message->getText("marker")
 * - $message->getText("marker [Pl.]")
